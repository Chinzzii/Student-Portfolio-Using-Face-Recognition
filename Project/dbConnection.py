...
All User Actions are defined in this class'''
    ...
    def addUser(self) : 
        ...
        try:
            ...
            query = f"insert into {User.student_table} values (%s,%s,%s,%s,%s,%s,%s,%s,%s)"    
    ...
    def updateUser(self):
        ...
        try : 
            ...
            if self.checkUser() : 
                ...
                updateKeys = [list(self.details.keys())[1:][i] for i in list(map(int,input("Enter fields you want to update --> ").rstrip().split()))]
