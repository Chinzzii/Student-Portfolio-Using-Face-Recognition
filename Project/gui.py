...
def useradd(): 
    #e1 = Entry(root,width = 20).grid(row = 1 , column = 2)
    e1.insert(0,"rudraksh")
...
buttonTryFR = Button(root , text = 'Try Face Recognition' , command = facerecognition).grid(row = 11 , column = 0 , columnspan = 2)

buttonGetUser = Button(root , text = 'Get User' , command = getuser).grid(row = 12 , column = 0 , columnspan = 2)
